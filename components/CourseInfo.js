...
const CourseInfo = ({ course }) => {
    ...
    return (
        <div className="flex flex-col gap-2">
            ...
            <div>
                {/* reviews for teacher*/}
                <p className="flex md:items-center gap-1 text-[#A8A8A8]"><Reviews /> {course.teacher_reviews} total reviews for this teacher</p>
                {/* reviews for this course */}
                <p className="flex items-center gap-1  text-[#A8A8A8]"><Reviews /> {course.course_reviews} reviews for this class</p>
            </div>
